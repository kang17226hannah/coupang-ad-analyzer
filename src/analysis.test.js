...
describe('weekly comparison and storage models',()=>{
 ...
 it('finds a multi-day week range',()=>assert.equal(weekRange([row({date:'2026-08-16',periodStart:'2026-08-16',periodEnd:'2026-08-16'}),row({date:'2026-08-10',periodStart:'2026-08-10',periodEnd:'2026-08-10'})]),'2026-08-10 ~ 2026-08-16'));
